...
/*intialize device file information*/
...
ssize_t pcd_write(struct file *filp, const char __user *buff, size_t count, loff_t *f_pos)
{
	...
	/*return num of bytes successfully return*/
	return count;
}
...
int pcd_open (struct inode *inode, struct file *filp)
{
	...
	/*to supply device private to other method of driver*/
	filp->private_data = pcdev_data;

	/*check permission*/
	ret = check_permission(pcdev_data,filp->f_mode);
...
MODULE_DESCRIPTION("A pseudo character driver of multi device");
